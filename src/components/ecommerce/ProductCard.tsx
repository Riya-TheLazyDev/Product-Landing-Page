...
export default function ProductCard({
  ...
  const wishlisted = isInWishlist(id.toString());
      ...
      >
        ...
        <div className="absolute top-4 right-4 z-20 sm:top-6 sm:right-6">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className={`flex h-8 w-8 items-center justify-center rounded-full border transition-all duration-700 backdrop-blur-md ${
              wishlisted
