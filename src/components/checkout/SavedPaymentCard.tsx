      ...
      >
        <div className="mb-3 flex items-start justify-between gap-3">
          <div className="flex items-center gap-2 text-primary/90">
            <CreditCard size={14} strokeWidth={1.25} className="shrink-0" />
            {method.isDefault && (
        ...
        <p className="font-serif text-lg text-white tracking-wide">{method.cardName}</p>
        <p className="mt-2 text-[12px] tracking-[0.25em] text-white/70">
          ···· {method.last4}
        </p>
